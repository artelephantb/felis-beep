# Felis Beep
*Felis Beep* is an extension for [Firefox](https://www.firefox.com), to add [BeepBox](https://beepbox.co) into [Scratch](https://scratch.mit.edu) (and [Scratch Script](https://scratchscript.quuq.dev))!
...
## Save Button
This button is different from the project's save button because this is the **only button that can save BeepBox songs**. The songs are stored in a joint location that can be accessed through every project. If you try to save a song with a name that already exists, the old song will be replaced **without warning**.

## Load Button
When pressed, the current song **will be replaced** with the desired song.
...
Felis Beep can be used in a text based Scratch editor called [Scratch Script](https://scratchscript.quuq.dev). Scratch Script is developed by [redspacecat](https://github.com/redspacecat).
